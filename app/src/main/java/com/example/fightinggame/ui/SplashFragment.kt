...
class SplashFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        isDataInserted = sharedPreferences.getBoolean("isDataInserted", false)
    ...
    private fun insertDatas() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                ...
                isDataInserted = true
                sharedPreferences.edit().putBoolean("isDataInserted", isDataInserted).apply()
            }
        }
    }
    ...
    val triviaList = listOf(
        Trivia(
            ...
            ans4 = "-1",
            number = 1,
            correctAnswerIndex = "0" // Answer is 0
        ),
        Trivia(
            ...
            ans4 = "< and >",
            number = 2,
            correctAnswerIndex = "{ and }" // Answer is { and }
        ),
        Trivia(
